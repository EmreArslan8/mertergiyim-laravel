...
|--------------------------------------------------------------------------
|
| Laravel yalnızca İngilizce dosyaları paketle birlikte gönderir; bu dosya
| olmadan formlar "validation.required" gibi ham anahtar basar. Panel ve
| Türkçe vitrin bu dosyayı kullanır. Diğer 9 dil için resources/lang/<dil>/
| altındaki karşılıkları var.
|
*/
...
return [
    ...
    'list' => ':attribute bir dizi olmalıdır.',
    ...
    'max_digits' => ':attribute en fazla :max hane içerebilir.',
    ...
    'min_digits' => ':attribute en az :min hane içermelidir.',
    ...
    'present_with' => ':values gönderildiğinde :attribute da gönderilmelidir.',
    'present_with_all' => ':values gönderildiğinde :attribute da gönderilmelidir.',
    ...
    'required_without_all' => ':values değerlerinin hiçbiri gönderilmediğinde :attribute zorunludur.',
    ...
    // Vitrin formlarındaki alan adları. Panelde Filament alan etiketini
    // kendisi gönderdiği için buraya panel alanlarını eklemek gerekmiyor.
    'attributes' => [
